...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<yard>, [">= 0.9.12", "~> 0.9.0"])
      s.add_development_dependency(%q<timecop>, [">= 0"])
      s.add_development_dependency(%q<simplecov>, [">= 0.3.8"])
      s.add_development_dependency(%q<rspec-rails>, ["~> 3.7.0"])
      s.add_development_dependency(%q<test-unit>, ["~> 3.2.0"])
      s.add_development_dependency(%q<byebug>, ["~> 10.0.0"])
      s.add_development_dependency(%q<webmock>, ["~> 3.3.0"])
    else
      s.add_dependency(%q<oauth>, [">= 0.4.4", "~> 0.4"])
      s.add_dependency(%q<oauth2>, [">= 0.8.0", "~> 1.0"])
      s.add_dependency(%q<bcrypt>, ["~> 3.1"])
      s.add_dependency(%q<yard>, [">= 0.9.12", "~> 0.9.0"])
      s.add_dependency(%q<timecop>, [">= 0"])
      s.add_dependency(%q<simplecov>, [">= 0.3.8"])
      s.add_dependency(%q<rspec-rails>, ["~> 3.7.0"])
      s.add_dependency(%q<test-unit>, ["~> 3.2.0"])
      s.add_dependency(%q<byebug>, ["~> 10.0.0"])
      s.add_dependency(%q<webmock>, ["~> 3.3.0"])
    end
  else
    s.add_dependency(%q<oauth>, [">= 0.4.4", "~> 0.4"])
    s.add_dependency(%q<oauth2>, [">= 0.8.0", "~> 1.0"])
